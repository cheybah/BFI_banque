/*-----------------------------------------------------------------------------------
    ...
    !function(e) {
        ...
        t.on("scroll", function() {
            ...
            o <= 50 ? (e("header").removeClass("scrollHeader").addClass("fixedHeader"),
            a.attr("src", "assets/img/logos/logo-inner.png"),
            i.attr("src", "assets/img/logos/logo.png")) : (e("header").removeClass("fixedHeader").addClass("scrollHeader"),
            a.attr("src", "assets/img/logos/logo.png"),
            i.attr("src", "assets/img/logos/logo.png"))
        }),
        t.on("scroll", function() {
        ...
        e(".tab1").click(function() {
            e(".second, .third, .four").fadeOut(),
            e(".first").fadeIn(1e3)
        }),
        e(".tab2").click(function() {
            e(".first, .third, .four").fadeOut(),
            e(".second").fadeIn(1e3)
        }),
        e(".tab3").click(function() {
            e(".second, .first, .four").fadeOut(),
            e(".third").fadeIn(1e3)
        }),
        ...
        o(),
        0 !== e(".copy-clipboard").length && (new ClipboardJS(".copy-clipboard"),
