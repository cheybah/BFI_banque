!function(o) {
    ...
    o.fn.menumaker = function(t) {
        ...
        return this.each(function() {
            ...
            e.find(".navbar-nav > li.has-sub > .submenu-button").on("click", function() {
                ...
                o(this).parents(".navbar-nav > li.has-sub").toggleClass("active").siblings(".has-sub").children(".sub-menu").slideUp().removeClass("open").parents("li").removeClass("active")
            }),
            e.find(".sub-menu > li.has-sub > .submenu-button").on("click", function() {
                o(this).next(".sub-menu").slideToggle(),
                o(this).siblings("ul").addClass("open").slideToggle(),
                o(this).parents(".sub-menu > li").toggleClass("active").siblings(".has-sub").children(".sub-menu").slideUp().removeClass("open").parents("li").removeClass("active"),
                o(this).siblings("ul").hasClass("open") && o(this).parents("li").eq(1).addClass("active")
            })) : e.addClass("dropdown"),
    ...
    o(document).ready(function() {
        ...
        o(".navbar-nav li").find('a[href="' + e + '"]').closest("li").addClass("active").parents().eq(1).addClass("current"),
        o(".navbar-nav li.has-sub ul li").find('a[href="' + e + '"]').parents().eq(4).addClass("current")
    }),
    o(".navbar-default .attr-nav").each(function() {
        o("li.search > a", this).on("click", function(t) {
            t.preventDefault(),
            o(".top-search").slideToggle()
        })
    }),
...
function(f) {
    f.fn.extend({
        easyResponsiveTabs: function(l) {
            ...
            this.each(function() {
                var i, o = f(this), t = o.find("ul.resp-tabs-list." + l.tabidentify), n = o.attr("id");
                o.find("ul.resp-tabs-list." + l.tabidentify + " li").addClass("resp-tab-item").addClass(l.tabidentify),
                o.css({
                    display: "block",
                    width: h
                }),
                "vertical" == l.type && o.find(".resp-tabs-container." + l.tabidentify).css("border-color", l.active_content_border_color),
                o.find(".resp-tabs-container." + l.tabidentify + " > div").addClass("resp-tab-content").addClass(l.tabidentify),
                "vertical" == c && o.addClass("resp-vtabs").addClass(l.tabidentify),
                1 == u && o.css({
                    width: "100%",
                    margin: "0px"
                }),
                "accordion" == c && (o.addClass("resp-easy-accordion").addClass(l.tabidentify),
                o.find(".resp-tabs-list").css("display", "none")),
                o.find(".resp-tab-content." + l.tabidentify).before("<h2 class='resp-accordion " + l.tabidentify + "' role='tab'><span class='resp-arrow'></span></h2>"),
                o.find(".resp-tab-content." + l.tabidentify).prev("h2").css({
                ...
                var r, a = 0;
                "" == d || null !== (r = d.match(new RegExp(n + "([0-9]+)"))) && 2 === r.length && (a = parseInt(r[1], 10) - 1,
                e < a && (a = 0)),
                f(o.find(".resp-tab-item." + l.tabidentify)[a]).addClass("resp-tab-active").css({
                ...
                f(o.find(".resp-tab-content." + l.tabidentify)[a]).addClass("resp-tab-content-active").addClass(l.tabidentify).attr("style", "display:block")),
                o.find("[role=tab]").each(function() {
                    f(this).on("click", function() {
                        var t, e = f(this), i = e.attr("aria-controls");
                        if (e.hasClass("resp-accordion") && e.hasClass("resp-tab-active"))
                            return o.find(".resp-tab-content-active." + l.tabidentify).slideUp("", function() {
                                f(this).addClass("resp-accordion-closed")
                            }),
                            e.removeClass("resp-tab-active").css({}),
                            !1;
                        !e.hasClass("resp-tab-active") && e.hasClass("resp-accordion") ? (o.find(".resp-tab-active." + l.tabidentify).removeClass("resp-tab-active").css({}),
                        o.find(".resp-tab-content-active." + l.tabidentify).slideUp().removeClass("resp-tab-content-active resp-accordion-closed"),
                        o.find("[aria-controls=" + i + "]").addClass("resp-tab-active").css({}),
                        o.find(".resp-tab-content[aria-labelledby = " + i + "]." + l.tabidentify).slideDown().addClass("resp-tab-content-active")) : (o.find(".resp-tab-active." + l.tabidentify).removeClass("resp-tab-active").css({}),
                        o.find(".resp-tab-content-active." + l.tabidentify).removeAttr("style").removeClass("resp-tab-content-active").removeClass("resp-accordion-closed"),
                        o.find("[aria-controls=" + i + "]").addClass("resp-tab-active").css({}),
                        o.find(".resp-tab-content[aria-labelledby = " + i + "]." + l.tabidentify).addClass("resp-tab-content-active").attr("style", "display:block")),
                        e.trigger("tabactivate", e),
                        p && (t = window.location.hash,
                        i.split("tab_item-"),
                        e = (e = "") != t ? (i = new RegExp(n + "[0-9]+"),
                        null != t.match(i) ? t.replace(i, e) : t + "|" + e) : "" + e,
...
function(l, i, o, a) {
    ...
    c.Workers = [{
        ...
        filter: ["width", "items", "settings"],
        run: function() {
            for (var t, e, i = this.settings.rtl ? 1 : -1, o = this._clones.length + this._items.length, n = -1, s = []; ++n < o; )
                t = s[n - 1] || 0,
        ...
        run: function() {
            for (var t, e, i = this.settings.rtl ? 1 : -1, o = 2 * this.settings.stagePadding, n = this.coordinates(this.current()) + o, s = n + this.width() * i, r = [], a = 0, l = this._coordinates.length; a < l; a++)
                t = this._coordinates[a - 1] || 0,
                e = Math.abs(this._coordinates[a]) + o * i,
                (this.op(t, "<=", n) && this.op(t, ">", s) || this.op(e, "<", n) && this.op(e, ">", s)) && r.push(a);
    ...
    c.prototype.setup = function() {
        ...
        delete o.responsive,
        o.responsiveClass && this.$element.attr("class", this.$element.attr("class").replace(new RegExp("(" + this.options.responsiveClass + "-)\\S+\\s","g"), "$1" + i))) : o = l.extend({}, this.options),
        this.trigger("change", {
            property: {
                name: "settings",
                value: o
    ...
    c.prototype.update = function() {
        for (var t = 0, e = this._pipe.length, i = l.proxy(function(t) {
            return this[t]
        }, this._invalidated), o = {}; t < e; )
            (this._invalidated.all || 0 < l.grep(this._pipe[t].filter, i).length) && this._pipe[t].run(o),
            t++;
        this._invalidated = {},
    ...
    c.prototype.onDragMove = function(t) {
        var e, i = null, o = null, n = this.difference(this._drag.pointer, this.pointer(t)), s = this.difference(this._drag.stage.start, n);
        this.is("dragging") && (t.preventDefault(),
        this.settings.loop ? (i = this.coordinates(this.minimum()),
        o = this.coordinates(this.maximum() + 1) - i,
        s.x = ((s.x - i) % o + o) % o + i) : (i = this.settings.rtl ? this.coordinates(this.maximum()) : this.coordinates(this.minimum()),
    ...
    c.prototype.closest = function(i, o) {
        ...
        return this.settings.freeDrag || l.each(r, l.proxy(function(t, e) {
            return "left" === o && e - 30 < i && i < e + 30 ? n = t : "right" === o && e - s - 30 < i && i < e - s + 30 ? n = t + 1 : this.op(i, "<", e) && this.op(i, ">", r[t + 1] !== a ? r[t + 1] : e - s) && (n = "left" === o ? t + 1 : t),
            -1 === n
        }, this)),
    ...
    c.prototype.maximum = function(t) {
        ...
        if (n.loop)
            ...
            if (e = this._items.length)
                ...
                o = this.$element.width(); e-- && !(o < (i += this._items[e].width() + this.settings.margin)); )
                    ;
            s = e + 1
        } else
    ...
    c.prototype.to = function(t, e) {
        var i, o = this.current(), n = t - this.relative(o), s = (0 < n) - (n < 0), r = this._items.length, a = this.minimum(), l = this.maximum();
        this.settings.loop ? (!this.settings.rewind && Math.abs(n) > r / 2 && (n += -1 * s * r),
        (i = (((t = o + n) - a) % r + r) % r + a) !== t && i - n <= l && 0 < i - n && (o = i - n,
        t = i,
        this.reset(o))) : t = this.settings.rewind ? (t % (l += 1) + l) % l : Math.max(a, Math.min(l, t)),
...
function(n, i) {
    ...
    o.prototype.update = function() {
        ...
        (e = Math.max.apply(null, o)) <= 1 && i && this._previousHeight && (e = this._previousHeight),
...
function(u, e) {
    ...
    i.prototype.fetch = function(t, e) {
        ...
        if (-1 < (o = r.match(/(http:|https:|)\/\/(player.|www.|app.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com|be\-nocookie\.com)|vzaar\.com)\/(video\/|videos\/|embed\/|channels\/.+\/|groups\/.+\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/))[3].indexOf("youtu"))
            i = "youtube";
        else if (-1 < o[3].indexOf("vimeo"))
            i = "vimeo";
        else {
    ...
    i.prototype.thumbnail = function(e, t) {
        ...
        var o, n, s = t.width && t.height ? "width:" + t.width + "px;height:" + t.height + "px;" : "", r = e.find("img"), a = "src", l = "", c = this._core.settings;
        if (e.wrap(u("<div/>", {
    ...
    i.prototype.play = function(t) {
        ...
        (t = u('<iframe frameborder="0" allowfullscreen mozallowfullscreen webkitAllowFullScreen ></iframe>')).attr("height", n),
        t.attr("width", o),
...
function(r) {
    ...
    e.prototype.swap = function() {
        ...
        n && o.one(r.support.animation.end, e).addClass("animated owl-animated-in").addClass(n)))
    }
    ,
...
function(o, n, e) {
    ...
    i.prototype._next = function(t) {
        this._call = n.setTimeout(o.proxy(this._next, this, t), this._timeout * (Math.round(this.read() / this._timeout) + 1) - this.read()),
...
function(n) {
    ...
    e.prototype.update = function() {
        var t, e, i = this._core.clones().length / 2, o = i + this._core.items().length, n = this._core.maximum(!0), s = this._core.settings, r = s.center || s.autoWidth || s.dotsData ? 1 : s.dotsEach || s.items;
    ...
    e.prototype.draw = function() {
        ...
        t.nav && (this._controls.$previous.toggleClass("disabled", !o && i <= this._core.minimum(!0)),
    ...
    e.prototype.getPosition = function(t) {
        ...
        return "page" == o.slideBy ? (e = n.inArray(this.current(), this._pages),
...
function(o, n) {
    ...
    var e = function(t) {
        ...
        this._handlers = {
            ...
            "changed.owl.carousel": o.proxy(function(t) {
                ...
                (t = o.map(this._hashes, function(t, e) {
                    return t === i ? e : null
        ...
        this.$element.on(this._handlers),
        o(n).on("hashchange.owl.navigation", o.proxy(function(t) {
    ...
    e.prototype.destroy = function() {
        var t, e;
        for (t in o(n).off("hashchange.owl.navigation"),
        this._handlers)
            this._core.$element.off(t, this._handlers[t]);
        for (e in Object.getOwnPropertyNames(this))
            "function" != typeof this[e] && (this[e] = null)
...
function(n, s) {
    ...
    o() && (n.support.animation = new String(c("animation")),
    n.support.animation.end = t.animation.end[n.support.animation]),
    e() && (n.support.transform = new String(c("transform")),
    ...
    i.fn.counterUp = function(t) {
        ...
        return this.each(function() {
            var l = i(this)
              , c = e;
            l.waypoint(function() {
                for (var t = [], e = c.time / c.delay, i = l.text(), o = /[0-9]+,[0-9]+/.test(i), i = i.replace(/,/g, ""), n = (/^[0-9]+$/.test(i),
                /^[0-9]+\.[0-9]+$/.test(i)), s = n ? (i.split(".")[1] || []).length : 0, r = e; 1 <= r; r--) {
                    var a = parseInt(i / e * r);
                    if (n && (a = parseFloat(i / e * r).toFixed(s)),
                    o)
...
function(f, n, t, m) {
    var o = "stellar"
      ...
      , s = function() {
        var t, e = /^(Moz|Webkit|Khtml|O|ms|Icab)(?=[A-Z])/, i = f("script")[0].style, o = "";
        for (t in i)
            if (e.test(t)) {
                o = t.match(e)[0];
                break
            }
        return "WebkitOpacity"in i && (o = "Webkit"),
    ...
    c.prototype = {
        ...
        _defineElements: function() {
            ...
            this.$element = this.element === n ? f("body") : this.$scrollElement,
            this.$viewportElement = this.options.viewportElement !== m ? f(this.options.viewportElement) : this.$scrollElement[0] === n || "scroll" === this.options.scrollProperty ? this.$scrollElement : this.$scrollElement.parent()
        },
        ...
        _defineSetters: function() {
            ...
            : f.noop,
            this._setPosition = r.setPosition || function(t, e, i, o, n) {
        ...
        refresh: function(t) {
            ...
            t && t.firstLoad && /WebKit/.test(navigator.userAgent) && f(n).on("load", function() {
        ...
        _findParticles: function() {
            ...
            this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function(t) {
                var e, i, o, n, s, r, a, l = f(this), c = 0, u = 0, h = 0, d = 0;
                ...
                e = l.position().left,
                i = l.position().top,
                o = "auto" === l.css("margin-left") ? 0 : parseInt(l.css("margin-left"), 10),
                n = "auto" === l.css("margin-top") ? 0 : parseInt(l.css("margin-top"), 10),
                r = l.offset().left - o,
                a = l.offset().top - n,
                ...
                o = l.data("stellar-horizontal-offset") !== m ? l.data("stellar-horizontal-offset") : s !== m && s.data("stellar-horizontal-offset") !== m ? s.data("stellar-horizontal-offset") : p.horizontalOffset,
                n = l.data("stellar-vertical-offset") !== m ? l.data("stellar-vertical-offset") : s !== m && s.data("stellar-vertical-offset") !== m ? s.data("stellar-vertical-offset") : p.verticalOffset,
                p.particles.push({
                    $element: l,
                    $offsetParent: s,
        ...
        _findBackgrounds: function() {
            var t, h = this, d = this._getScrollLeft(), p = this._getScrollTop();
            this.backgrounds = [],
            ...
            t.each(function() {
                var t, e, i, o, n, s = f(this), r = y(s), a = 0, l = 0, c = 0, u = 0;
                if (s.data("stellar-backgroundIsActive")) {
                    if (s.data("stellar-backgroundIsActive") !== this)
                        return
                } else
                    s.data("stellar-backgroundIsActive", this);
                s.data("stellar-backgroundStartingLeft") ? g(s, s.data("stellar-backgroundStartingLeft"), s.data("stellar-backgroundStartingTop")) : (s.data("stellar-backgroundStartingLeft", r[0]),
                s.data("stellar-backgroundStartingTop", r[1])),
                t = "auto" === s.css("margin-left") ? 0 : parseInt(s.css("margin-left"), 10),
                e = "auto" === s.css("margin-top") ? 0 : parseInt(s.css("margin-top"), 10),
                i = s.offset().left - t - d,
                o = s.offset().top - e - p,
                ...
                t = s.data("stellar-horizontal-offset") !== m ? s.data("stellar-horizontal-offset") : n !== m && n.data("stellar-horizontal-offset") !== m ? n.data("stellar-horizontal-offset") : h.horizontalOffset,
                e = s.data("stellar-vertical-offset") !== m ? s.data("stellar-vertical-offset") : n !== m && n.data("stellar-vertical-offset") !== m ? n.data("stellar-vertical-offset") : h.verticalOffset,
                h.backgrounds.push({
                    $element: s,
                    $offsetParent: n,
                    ...
                    parentOffsetLeft: a,
                    parentOffsetTop: l,
                    stellarRatio: s.data("stellar-background-ratio") === m ? 1 : s.data("stellar-background-ratio")
                })
            }))
        },
        _reset: function() {
            ...
            for (n = this.backgrounds.length - 1; 0 <= n; n--)
                (o = this.backgrounds[n]).$element.data("stellar-backgroundStartingLeft", null).data("stellar-backgroundStartingTop", null),
        ...
        destroy: function() {
            ...
            f(n).unbind("load." + this.name).unbind("resize." + this.name)
        },
        ...
        _repositionElements: function() {
            var t, e, i, o, n, s, r, a, l, c, u = this._getScrollLeft(), h = this._getScrollTop(), d = !0, p = !0;
            if (this.currentScrollLeft !== u || this.currentScrollTop !== h || this.currentWidth !== this.viewportWidth || this.currentHeight !== this.viewportHeight) {
                ...
                for (c = this.backgrounds.length - 1; 0 <= c; c--)
                    ...
                    o = this.options.horizontalScrolling ? (u + i.horizontalOffset - this.viewportOffsetLeft - i.startingOffsetLeft + i.parentOffsetLeft - i.startingBackgroundPositionLeft) * (e - i.stellarRatio) + "px" : i.startingValueLeft,
                    n = this.options.verticalScrolling ? (h + i.verticalOffset - this.viewportOffsetTop - i.startingOffsetTop + i.parentOffsetTop - i.startingBackgroundPositionTop) * (e - i.stellarRatio) + "px" : i.startingValueTop,
                    g(i.$element, o, n)
            }
        },
...
function() {
    ...
    i.prototype.handleScroll = function() {
        ...
        for (t in o) {
            var n, s = o[t], r = s.newScroll > s.oldScroll ? s.forward : s.backward;
            for (n in this.waypoints[t]) {
                var a, l, c = this.waypoints[t][n];
                null !== c.triggerPoint && (a = s.oldScroll < c.triggerPoint,
    ...
    i.prototype.refresh = function() {
        var t, e, i = this.element == this.element.window, o = i ? void 0 : this.adapter.offset(), n = {};
        ...
        t = {
            ...
            for (s in this.waypoints[e]) {
                var a, l = this.waypoints[e][s], c = l.options.offset, u = l.triggerPoint, h = 0, d = null == u;
                ...
                u = !a && !c,
                !d && (a && c) ? (l.queueTrigger(r.backward),
                n[l.group.id] = l.group) : (!d && u || d && r.oldScroll >= l.triggerPoint) && (l.queueTrigger(r.forward),
...
function(c) {
    ...
    c.fn.countdown = function(t, s) {
        ...
        function e() {
            ...
            e = Math.floor(i / 60);
            i -= 60 * e,
            1 == o ? r.find(".timeRefDays").text("day") : r.find(".timeRefDays").text("days"),
            1 == n ? r.find(".timeRefHours").text("hour") : r.find(".timeRefHours").text("hours"),
            ...
            "on" == a.format && (o = 2 <= String(o).length ? o : "0" + o,
            ...
            clearInterval(l)) : (r.find(".days").text(o),
            r.find(".hours").text(n),
...
function(t) {
    ...
    var f, o, m, n, g, e, l = "Close", y = "BeforeClose", v = "MarkupParse", b = "Open", w = ".mfp", _ = "mfp-ready", i = "mfp-removing", r = "mfp-prevent-close", a = !!window.jQuery, x = c(window);
    t.prototype = {
        constructor: t,
        init: function() {
        ...
        open: function(t) {
            ...
            if (!f.isOpen) {
                ...
                f.bgOverlay || (f.bgOverlay = h("bg").on("click" + w, function() {
                    f.close()
                }),
                f.wrap = h("wrap").attr("tabindex", -1).on("click" + w, function(t) {
                ...
                d("BeforeOpen"),
                f.st.showCloseBtn && (f.st.closeBtnInside ? (u(v, function(t, e, i, o) {
                ...
                setTimeout(function() {
                    f.content ? (f._addClassToMFP(_),
                    f._setFocus()) : f.bgOverlay.addClass(_),
    ...
    c.fn.magnificPopup = function(t) {
        s();
        var e, i, o, n = c(this);
        return "string" == typeof t ? "open" === t ? (e = a ? n.data("magnificPopup") : n[0].magnificPopup,
        i = parseInt(arguments[1], 10) || 0,
        o = e.items ? e.items[i] : (o = n,
        e.delegate && (o = o.find(e.delegate)),
        o.eq(i)),
        f._openClick({
            mfpEl: o
        }, n, e)) : f.isOpen && f[t].apply(f, Array.prototype.slice.call(arguments, 1)) : (t = c.extend(!0, {}, t),
    ...
    c.magnificPopup.registerModule(z, {
        ...
        proto: {
            ...
            getInline: function(t, e) {
                if (C(),
                t.src) {
                    var i, o = f.st.inline, n = c(t.src);
                    return n.length ? ((i = n[0].parentNode) && i.tagName && (T || ($ = o.hiddenClass,
                    T = h($),
                    $ = "mfp-" + $),
                    S = n.after(T).detach().removeClass($)),
                ...
                var i = 0
                  ...
                  , n = function(t) {
                    ...
                    O = setInterval(function() {
                        return 0 < o.naturalWidth ? void f._onImageHasSize(e) : (200 < i && clearInterval(O),
    ...
    c.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            initZoom: function() {
                var t, e, i, o, n, s, r = f.st.zoom, a = ".zoom";
                ...
                u("BuildControls" + a, function() {
                    ...
                    (t = f._getItemToZoom()) ? ((i = n(t)).css(f._getOffset()),
                    f.wrap.append(i),
            ...
            _getOffset: function(t) {
                ...
                A ? o["-moz-transform"] = o.transform = "translate(" + i.left + "px," + i.top + "px)" : (o.left = i.left,
                o.top = i.top),
                o
            }
        }
    ...
    c.magnificPopup.registerModule(M, {
        ...
        proto: {
            ...
            getIframe: function(t, e) {
                ...
                var n = {};
                return o.srcAction && (n[o.srcAction] = i),
    ...
    c.magnificPopup.registerModule(D, {
        ...
        proto: {
            initRetina: function() {
                ...
                o = i.ratio,
                1 < (o = isNaN(o) ? o() : o) && (u("ImageHasSize." + D, function(t, e) {
                    e.img.css({
...
function(t, e) {
    ...
    !function() {
        ...
        function e(t, e) {
            ...
            this.s.dynamic ? this.$items = this.s.dynamicEl : "this" === this.s.selector ? this.$items = this.$el : "" !== this.s.selector ? this.s.selectWithin ? this.$items = f(this.s.selectWithin).find(this.s.selector) : this.$items = this.$el.find(f(this.s.selector)) : this.$items = this.$el.children(),
            this.$slide = "",
            this.$outer = "",
            this.init(),
            this
        ...
        e.prototype.init = function() {
            ...
            f("body").hasClass("lg-on") || (setTimeout(function() {
                t.build(t.index)
            }),
            ...
            f("body").hasClass("lg-on") || setTimeout(function() {
                ...
                f("body").hasClass("lg-on") || (t.build(t.index),
                f("body").addClass("lg-on"))
            })
        }
        ,
        ...
        e.prototype.structure = function() {
            var t = ""
              ...
              , o = ""
              , n = this;
            for (f("body").append('<div class="lg-backdrop"></div>'),
            f(".lg-backdrop").css("transition-duration", this.s.backdropDuration + "ms"),
            ...
            this.doCss() && ((o = this.$outer.find(".lg-inner")).css("transition-timing-function", this.s.cssEasing),
        ...
        e.prototype.setTop = function() {
            var t, e, i;
            "100%" !== this.s.height && (e = ((t = f(window).height()) - parseInt(this.s.height, 10)) / 2,
        ...
        e.prototype.addHtml = function(t) {
            var e, i, o, n = null;
            this.s.dynamic ? this.s.dynamicEl[t].subHtmlUrl ? e = this.s.dynamicEl[t].subHtmlUrl : n = this.s.dynamicEl[t].subHtml : (i = this.$items.eq(t)).attr("data-sub-html-url") ? e = i.attr("data-sub-html-url") : (n = i.attr("data-sub-html"),
            this.s.getCaptionFromTitleOrAlt && !n && (n = i.attr("title") || i.find("img").first().attr("alt"))),
            e || (null != n ? "." !== (o = n.substring(0, 1)) && "#" !== o || (n = (this.s.subHtmlSelectorRelative && !this.s.dynamic ? i.find(n) : f(n)).html()) : n = ""),
            ".lg-sub-html" === this.s.appendSubHtmlTo ? e ? this.$outer.find(this.s.appendSubHtmlTo).load(e) : this.$outer.find(this.s.appendSubHtmlTo).html(n) : e ? this.$slide.eq(t).load(e) : this.$slide.eq(t).append(n),
            null != n && ("" === n ? this.$outer.find(this.s.appendSubHtmlTo).addClass("lg-empty-html") : this.$outer.find(this.s.appendSubHtmlTo).removeClass("lg-empty-html")),
        ...
        e.prototype.loadContent = function(e, t, i) {
            var o, a, n, s, r, l, c = this, u = !1, h = function(t) {
            ...
            }, d = c.s.dynamic ? (c.s.dynamicEl[e].poster && (u = !0,
            n = c.s.dynamicEl[e].poster),
            r = c.s.dynamicEl[e].html,
            a = c.s.dynamicEl[e].src,
            l = c.s.dynamicEl[e].alt,
            c.s.dynamicEl[e].responsive && h(c.s.dynamicEl[e].responsive.split(",")),
            s = c.s.dynamicEl[e].srcset,
            c.s.dynamicEl[e].sizes) : ((p = c.$items.eq(e)).attr("data-poster") && (u = !0,
            n = p.attr("data-poster")),
            r = p.attr("data-html"),
            a = p.attr("href") || p.attr("data-src"),
            l = p.attr("title") || p.find("img").first().attr("alt"),
            p.attr("data-responsive") && h(p.attr("data-responsive").split(",")),
            s = p.attr("data-srcset"),
            p.attr("data-sizes")), h = !1;
            c.s.dynamic ? c.s.dynamicEl[e].iframe && (h = !0) : "true" === c.$items.eq(e).attr("data-iframe") && (h = !0);
            var p = c.isVideo(a, e);
            if (!c.$slide.eq(e).hasClass("lg-loaded")) {
                if (h ? c.$slide.eq(e).prepend('<div class="lg-video-cont lg-has-iframe" style="max-width:' + c.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + a + '"  allowfullscreen="true"></iframe></div></div>') : u ? (h = "",
                h = p && p.youtube ? "lg-has-youtube" : p && p.vimeo ? "lg-has-vimeo" : "lg-has-html5",
                c.$slide.eq(e).prepend('<div class="lg-video-cont ' + h + ' "><div class="lg-video"><span class="lg-video-play"></span><img class="lg-object lg-has-poster" src="' + n + '" /></div></div>')) : p ? (c.$slide.eq(e).prepend('<div class="lg-video-cont "><div class="lg-video"></div></div>'),
        ...
        e.prototype.slide = function(t, e, i, o) {
            var n, s, r, a, l, c = this.$outer.find(".lg-current").index(), u = this;
            u.lGalleryOn && c === t || (n = this.$slide.length,
            s = u.lGalleryOn ? this.s.speed : 0,
            u.lgBusy || (this.s.download && ((r = u.s.dynamic ? !1 !== u.s.dynamicEl[t].downloadUrl && (u.s.dynamicEl[t].downloadUrl || u.s.dynamicEl[t].src) : "false" !== u.$items.eq(t).attr("data-download-url") && (u.$items.eq(t).attr("data-download-url") || u.$items.eq(t).attr("href") || u.$items.eq(t).attr("data-src"))) ? (f("#lg-download").attr("href", r),
            ...
            2 < n ? (a = t - 1,
            l = t + 1,
            (0 === t && c === n - 1 || t === n - 1 && 0 === c) && (l = 0,
            a = n - 1)) : (a = 0,
            l = 1),
            "prev" === o ? u.$slide.eq(l).addClass("lg-next-slide") : u.$slide.eq(a).addClass("lg-prev-slide"),
            u.$slide.eq(t).addClass("lg-current")) : (u.$outer.addClass("lg-no-trans"),
            this.$slide.removeClass("lg-prev-slide lg-next-slide"),
            "prev" === o ? (this.$slide.eq(t).addClass("lg-prev-slide"),
        ...
        e.prototype.touchMove = function(t, e) {
            ...
            this.setTranslate(f(".lg-prev-slide"), -this.$slide.eq(this.index).width() + t, 0),
            this.setTranslate(f(".lg-next-slide"), this.$slide.eq(this.index).width() + t, 0))
        }
        ,
        ...
        e.prototype.enableSwipe = function() {
            ...
            e.$slide.on("touchend.lg", function() {
                e.$outer.hasClass("lg-zoomed") || (n ? (n = !1,
                e.touchEnd(o - i)) : e.$el.trigger("onSlideClick.lg"))
            }))
        }
        ,
        e.prototype.enableDrag = function() {
            ...
            e.s.enableDrag && e.doCss() && (e.$slide.on("mousedown.lg", function(t) {
                e.$outer.hasClass("lg-zoomed") || e.lgBusy || f(t.target).text().trim() || (t.preventDefault(),
                e.manageSwipeClass(),
                i = t.pageX,
                n = !0,
            ...
            f(window).on("mouseup.lg", function(t) {
                s ? (s = !1,
                e.touchEnd(o - i),
                e.$el.trigger("onDragend.lg")) : (f(t.target).hasClass("lg-object") || f(t.target).hasClass("lg-video-play")) && e.$el.trigger("onSlideClick.lg"),
                n && (n = !1,
        ...
        f.fn.lightGallery = function(t) {
            return this.each(function() {
                if (f.data(this, "lightGallery"))
                    ...
                    f.data(this, "lightGallery", new e(this,t))
            })
        }
        ,
...
function(t, e) {
    ...
    !function() {
        ...
        t.prototype.destroy = function() {
            ...
            o(document).off("fullscreenchange.lg webkitfullscreenchange.lg mozfullscreenchange.lg MSFullscreenChange.lg")
        }
        ,
        ...
        t.prototype.init = function() {
            ...
            i.core.s.dynamic)
                for (var s = 0; s < i.core.s.dynamicEl.length; s++)
                    n += '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' + i.core.s.dynamicEl[s].thumb + '" /></div></span>';
            else
            ...
            (o = i.core.$outer.find(".lg-pager-cont")).on("click.lg touchend.lg", function() {
                var t = r(this);
...
function(t, e) {
    ...
    !function() {
        ...
        t.prototype.build = function() {
            ...
            function e(t, e, i) {
                var o, t = n.core.isVideo(t, i) || {}, i = "";
                t.youtube || t.vimeo || t.dailymotion ? t.youtube ? o = n.core.s.loadYoutubeThumbnail ? "//img.youtube.com/vi/" + t.youtube[1] + "/" + n.core.s.youtubeThumbSize + ".jpg" : e : t.vimeo ? n.core.s.loadVimeoThumbnail ? (o = "//i.vimeocdn.com/video/error_" + r + ".jpg",
                i = t.vimeo[1]) : o = e : t.dailymotion && (o = n.core.s.loadDailymotionThumbnail ? "//www.dailymotion.com/thumbnail/video/" + t.dailymotion[1] : e) : o = e,
                s += '<div data-vimeo-id="' + i + '" class="lg-thumb-item" style="width:' + n.core.s.thumbWidth + "px; height: " + n.core.s.thumbHeight + "; margin-right: " + n.core.s.thumbMargin + 'px"><img src="' + o + '" /></div>',
                i = ""
            }
            if (n.core.$outer.addClass("lg-has-thumb"),
            ...
            n.core.s.animateThumb && n.core.$outer.find(".lg-thumb").css({
            ...
            t.on("click.lg touchend.lg", function() {
                var t = a(this);
                setTimeout(function() {
                    (!n.thumbClickable || n.core.lgBusy) && n.core.doCss() || (n.core.index = t.index(),
        ...
        t.prototype.enableThumbDrag = function() {
            ...
            a(window).on("mousemove.lg.thumb", function(t) {
                ...
                (r -= o - i) > e.thumbTotalWidth - e.thumbOuterWidth && (r = e.thumbTotalWidth - e.thumbOuterWidth),
                r < 0 && (r = 0),
                e.setTranslate(r))
            }),
            a(window).on("mouseup.lg.thumb", function() {
                ...
                e.left = r,
                Math.abs(o - i) < e.core.s.swipeThreshold && (e.thumbClickable = !0)) : e.thumbClickable = !0,
                n && (n = !1,
        ...
        t.prototype.enableThumbSwipe = function() {
            ...
            e.core.$outer.find(".lg-thumb").on("touchmove.lg", function(t) {
                ...
                e.$thumbOuter.addClass("lg-dragging"),
                s = e.left,
                (s -= o - i) > e.thumbTotalWidth - e.thumbOuterWidth && (s = e.thumbTotalWidth - e.thumbOuterWidth),
                s < 0 && (s = 0),
                e.setTranslate(s))
            }),
            e.core.$outer.find(".lg-thumb").on("touchend.lg", function() {
                e.thumbTotalWidth > e.thumbOuterWidth && n ? (n = !1,
                e.$thumbOuter.removeClass("lg-dragging"),
                Math.abs(o - i) < e.core.s.swipeThreshold && (e.thumbClickable = !0),
    ...
    !function() {
        ...
        t.prototype.init = function() {
            ...
            o.core.$el.on("hasVideo.lg.tm", function(t, e, i, o) {
                var n = this;
                if (n.core.$slide.eq(e).find(".lg-video").append(n.loadVideo(i, "lg-object", !0, e, o)),
                o)
                    if (n.core.s.videojs)
                        try {
                        ...
                        !n.videoLoaded && n.core.s.autoplayFirstVideo && n.core.$slide.eq(e).find(".lg-html5").get(0).play()
            }
            .bind(this)),
            ...
            .bind(this)),
            o.core.doCss() && 1 < o.core.$items.length && (o.core.s.enableSwipe || o.core.s.enableDrag) ? o.core.$el.on("onSlideClick.lg.tm", function() {
            ...
            o.core.s.autoplayFirstVideo && o.core.$el.on("onAferAppendSlide.lg.tm", function(t, e) {
                var i;
                o.core.lGalleryOn || (i = o.core.$slide.eq(e),
                setTimeout(function() {
        ...
        t.prototype.loadVideo = function(t, e, i, o, n) {
            ...
            o.youtube ? (l = "?wmode=opaque&autoplay=" + a + "&enablejsapi=1",
            this.core.s.youtubePlayerParams && (l = l + "&" + c.param(this.core.s.youtubePlayerParams)),
            r = '<iframe class="lg-video-object lg-youtube ' + e + '" ' + s + ' width="560" height="315" src="//www.youtube.com/embed/' + o.youtube[1] + l + '" frameborder="0" allowfullscreen></iframe>') : o.vimeo ? (l = "?autoplay=" + a + "&api=1",
            this.core.s.vimeoPlayerParams && (l = l + "&" + c.param(this.core.s.vimeoPlayerParams)),
            r = '<iframe class="lg-video-object lg-vimeo ' + e + '" ' + s + ' width="560" height="315"  src="//player.vimeo.com/video/' + o.vimeo[1] + l + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>') : o.dailymotion ? (l = "?wmode=opaque&autoplay=" + a + "&api=postMessage",
            this.core.s.dailymotionPlayerParams && (l = l + "&" + c.param(this.core.s.dailymotionPlayerParams)),
            r = '<iframe class="lg-video-object lg-dailymotion ' + e + '" ' + s + ' width="560" height="315" src="//www.dailymotion.com/embed/video/' + o.dailymotion[1] + l + '" frameborder="0" allowfullscreen></iframe>') : o.html5 ? ("." !== (i = n.substring(0, 1)) && "#" !== i || (n = c(n).html()),
            r = n) : o.vk && (l = "&autoplay=" + a,
            this.core.s.vkPlayerParams && (l = l + "&" + c.param(this.core.s.vkPlayerParams)),
            r = '<iframe class="lg-video-object lg-vk ' + e + '" ' + s + ' width="560" height="315" src="//vk.com/video_ext.php?' + o.vk[1] + l + '" frameborder="0" allowfullscreen></iframe>'),
            r
        }
        ,
            ...
            if (i.find(".lg-object").hasClass("lg-has-poster") && i.find(".lg-object").is(":visible"))
                if (i.hasClass("lg-has-video")) {
                    ...
                    if (t)
                        ...
                        n.contentWindow.postMessage("play", "*");
                    else if (s)
                        if (o.core.s.videojs)
                            try {
                                videojs(s).play()
                    ...
                    n = function(t, e) {
                        if (i.find(".lg-video").append(o.loadVideo(t, "", !1, o.core.index, e)),
                        e)
                            if (o.core.s.videojs)
                                try {
...
function(t, e) {
    ...
    !function() {
        "use strict";
        function t(t) {
            return this.core = d(t).data("lightGallery"),
            this.core.s = d.extend({}, o, this.core.s),
        ...
        t.prototype.init = function() {
            ...
            s.core.s.actualSize && (t += '<button type="button" aria-label="Actual size" id="lg-actual-size" class="lg-icon"></button>'),
            s.core.s.useLeftForZoom ? s.core.$outer.addClass("lg-use-left-for-zoom") : s.core.$outer.addClass("lg-use-transition-for-zoom"),
            ...
            s.core.$el.on("onSlideItemLoad.lg.tm.zoom", function(t, e, i) {
                ...
                d("body").hasClass("lg-from-hash") && i ? o = 0 : d("body").removeClass("lg-from-hash"),
            ...
            function e(t) {
                ...
                (s.core.s.useLeftForZoom ? e.parent().css({
                    left: -i + "px",
                    top: -o + "px"
            ...
            function o(t, e, i, o) {
                ...
                s.core.$outer.hasClass("lg-zoomed") ? a = 1 : n < e && (a = e / n || 2),
                o ? (s.pageX = d(window).width() / 2,
                s.pageY = d(window).height() / 2 + d(window).scrollTop()) : (s.pageX = t.pageX || t.originalEvent.targetTouches[0].pageX,
            ...
            d(window).on("resize.lg.zoom scroll.lg.zoom orientationchange.lg.zoom", function() {
                s.pageX = d(window).width() / 2,
                s.pageY = d(window).height() / 2 + d(window).scrollTop(),
                e(a)
            }),
            d("#lg-zoom-out").on("click.lg", function() {
                s.core.$outer.find(".lg-current .lg-image").length && (a -= s.core.s.scale,
                r())
            }),
        ...
        t.prototype.getModifier = function(t, e, i) {
            ...
            if (!n)
                return 1;
            var s, i = 1;
            return "X" === e ? (s = Math.sign(parseFloat(n[0])),
            0 === t || 180 === t ? i = 1 : 90 === t && (i = -90 === o && 1 === s || 90 === o && -1 === s ? -1 : 1),
            i *= s) : (s = Math.sign(parseFloat(n[3])),
            0 === t || 180 === t ? i = 1 : 90 === t && (t = parseFloat(n[1]),
            n = parseFloat(n[2]),
            i = Math.sign(t * n * o * s)),
            i *= s),
            i
        ...
        t.prototype.zoomSwipe = function() {
            var o, n = this, s = {}, r = {}, a = !1, l = !1, c = !1, u = 0;
            n.core.$slide.on("touchstart.lg", function(t) {
                var e;
                n.core.$outer.hasClass("lg-zoomed") && (e = n.core.$slide.eq(n.core.index).find(".lg-object"),
                ...
                s = n.getSwipeCords(t, Math.abs(u))))
            }),
            n.core.$slide.on("touchmove.lg", function(t) {
                var e, i;
                n.core.$outer.hasClass("lg-zoomed") && (e = n.core.$slide.eq(n.core.index).find(".lg-img-wrap"),
                t.preventDefault(),
                a = !0,
                r = n.getSwipeCords(t, Math.abs(u)),
                n.core.$outer.addClass("lg-zoom-dragging"),
                i = c ? -Math.abs(e.attr("data-y")) + (r.y - s.y) * n.getModifier(u, "Y", o) : -Math.abs(e.attr("data-y")),
                t = l ? -Math.abs(e.attr("data-x")) + (r.x - s.x) * n.getModifier(u, "X", o) : -Math.abs(e.attr("data-x")),
                (15 < Math.abs(r.x - s.x) || 15 < Math.abs(r.y - s.y)) && (n.core.s.useLeftForZoom ? e.css({
                    left: t + "px",
                    top: i + "px"
                }) : e.css("transform", "translate3d(" + t + "px, " + i + "px, 0)")))
            }),
            n.core.$slide.on("touchend.lg", function() {
                n.core.$outer.hasClass("lg-zoomed") && a && (a = !1,
        ...
        t.prototype.zoomDrag = function() {
            var o, n = this, s = {}, r = {}, a = !1, l = !1, c = !1, u = !1, h = 0;
            n.core.$slide.on("mousedown.lg.zoom", function(t) {
                o = n.core.$slide.eq(n.core.index).find(".lg-img-rotate")[0],
                h = n.getCurrentRotation(o);
                var e = n.core.$slide.eq(n.core.index).find(".lg-object")
                  , e = n.getDragAllowedAxises(e, Math.abs(h));
                u = e.allowY,
                c = e.allowX,
                n.core.$outer.hasClass("lg-zoomed") && d(t.target).hasClass("lg-object") && (c || u) && (t.preventDefault(),
                s = n.getDragCords(t, Math.abs(h)),
                a = !0,
            ...
            d(window).on("mousemove.lg.zoom", function(t) {
                var e, i;
                a && (e = n.core.$slide.eq(n.core.index).find(".lg-img-wrap"),
                l = !0,
                r = n.getDragCords(t, Math.abs(h)),
                n.core.$outer.addClass("lg-zoom-dragging"),
                i = u ? -Math.abs(e.attr("data-y")) + (r.y - s.y) * n.getModifier(h, "Y", o) : -Math.abs(e.attr("data-y")),
                t = c ? -Math.abs(e.attr("data-x")) + (r.x - s.x) * n.getModifier(h, "X", o) : -Math.abs(e.attr("data-x")),
                n.core.s.useLeftForZoom ? e.css({
                    left: t + "px",
                    top: i + "px"
                }) : e.css("transform", "translate3d(" + t + "px, " + i + "px, 0)"))
            }),
            d(window).on("mouseup.lg.zoom", function(t) {
                a && (a = !1,
                n.core.$outer.removeClass("lg-zoom-dragging"),
                !l || s.x === r.x && s.y === r.y || (r = n.getDragCords(t, Math.abs(h)),
                n.touchendZoom(s, r, c, u, h)),
                l = !1),
        ...
        t.prototype.touchendZoom = function(t, e, i, o, n) {
            ...
            (15 < Math.abs(e.x - t.x) || 15 < Math.abs(e.y - t.y)) && (o && (l <= -n.maxY ? l = -n.maxY : l >= -n.minY && (l = -n.minY)),
            i && (c <= -n.maxX ? c = -n.maxX : c >= -n.minX && (c = -n.minX)),
            o ? r.attr("data-y", Math.abs(l)) : l = -Math.abs(r.attr("data-y")),
            i ? r.attr("data-x", Math.abs(c)) : c = -Math.abs(r.attr("data-x")),
            s.core.s.useLeftForZoom ? r.css({
                left: c + "px",
                top: l + "px"
    ...
    !function() {
        ...
        t.prototype.init = function() {
            ...
            i(window).on("hashchange.lg.hash", function() {
                ...
                -1 < e.indexOf("lg=" + o.core.s.galleryId) ? o.core.slide(t, !1, !1) : o.core.lGalleryOn && o.core.destroy()
            })
        }
        ,
        t.prototype.destroy = function() {
...
function(t, e) {
    ...
    !function() {
        ...
        t.prototype.init = function() {
            ...
            t += o.core.s.facebook ? '<li><a id="lg-share-facebook" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.facebookDropdownText + "</span></a></li>" : "",
            t += o.core.s.twitter ? '<li><a id="lg-share-twitter" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.twitterDropdownText + "</span></a></li>" : "",
            t += o.core.s.pinterest ? '<li><a id="lg-share-pinterest" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.pinterestDropdownText + "</span></a></li>" : "",
            t += "</ul></button>",
            this.core.$outer.find(".lg-toolbar").append(t),
            ...
            o.core.$el.on("onAfterSlide.lg.tm", function(t, e, i) {
                setTimeout(function() {
                    n("#lg-share-facebook").attr("href", "https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent(o.getSahreProps(i, "facebookShareUrl") || window.location.href)),
                    n("#lg-share-twitter").attr("href", "https://twitter.com/intent/tweet?text=" + o.getSahreProps(i, "tweetText") + "&url=" + encodeURIComponent(o.getSahreProps(i, "twitterShareUrl") || window.location.href)),
                    n("#lg-share-pinterest").attr("href", "http://www.pinterest.com/pin/create/button/?url=" + encodeURIComponent(o.getSahreProps(i, "pinterestShareUrl") || window.location.href) + "&media=" + encodeURIComponent(o.getSahreProps(i, "src")) + "&description=" + o.getSahreProps(i, "pinterestText"))
                }, 100)
            })
        }
        ,
...
function(t) {
    ...
    function e(t) {
        var e, i = t || window.event, o = m.call(arguments, 1), n = 0, s = 0, r = 0, a = 0, l = 0, c = 0;
        if ((t = u.event.fix(i)).type = "mousewheel",
        ...
        0 === r && (n = -1 * s)),
        0 !== r || 0 !== s) {
            1 === i.deltaMode ? (n *= e = u.data(this, "mousewheel-line-height"),
            r *= e,
            s *= e) : 2 === i.deltaMode && (n *= e = u.data(this, "mousewheel-page-height"),
            r *= e,
            s *= e);
            var a = Math.max(Math.abs(r), Math.abs(s));
            return f && !(a < f) || d(i, f = a) && (f /= 40),
            d(i, a) && (n /= 40,
            s /= 40,
            r /= 40),
            ...
            g.settings.normalizeOffset && this.getBoundingClientRect && (a = this.getBoundingClientRect(),
            l = t.clientX - a.left,
            c = t.clientY - a.top),
            t.deltaX = s,
            t.deltaY = r,
    ...
    var p, f, t = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"], i = "onwheel"in document || 9 <= document.documentMode ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"], m = Array.prototype.slice;
    if (u.event.fixHooks)
        for (var o = t.length; o; )
            u.event.fixHooks[t[--o]] = u.event.mouseHooks;
    ...
    function i(l, c, u) {
        ...
        u.fn[l] = function(t) {
            if ("string" != typeof t)
                ...
                this;
            var o, n, s, r, a, e = h.call(arguments, 1);
            return n = e,
            r = "$()." + l + '("' + (o = t) + '")',
            (t = this).each(function(t, e) {
                var i = u.data(e, l);
                i ? (e = i[o]) && "_" != o.charAt(0) ? (i = e.apply(i, n),
...
function(t, e) {
    ...
    function m(t) {
        ...
        u = f(d),
        m.isBoxSizeOuter = g = 200 == p(u.width),
        h.removeChild(d)),
        ...
        t && "object" == typeof t && t.nodeType) {
            ...
            var a = i.paddingLeft + i.paddingRight
              ...
              , t = o && g
              , o = p(e.width);
            !1 !== o && (i.width = o + (t ? 0 : a + h));
            o = p(e.height);
            return !1 !== o && (i.height = o + (t ? 0 : l + d)),
    ...
    , y = ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom", "marginLeft", "marginRight", "marginTop", "marginBottom", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth"], v = y.length, b = !1;
    return m
}),
function(t, e) {
    "use strict";
...
function(t, e) {
    ...
    t.getPosition = function() {
        ...
        n -= i ? t.paddingTop : t.paddingBottom,
        this.position.x = o,
        this.position.y = n
    }
    ,
    t.layoutPosition = function() {
        ...
        e[s] = this.getXValue(n),
        e[i] = "";
        n = o ? "paddingTop" : "paddingBottom",
        i = o ? "top" : "bottom",
        o = o ? "bottom" : "top",
        n = this.position.y + t[n];
        e[i] = this.getYValue(n),
        e[o] = "",
        this.css(e),
...
function(n, s) {
    ...
    r.create = function(t, e) {
        var i = a(r);
        return i.defaults = o.extend({}, r.defaults),
...
function(t, e) {
    ...
    t._getItemLayoutPosition = function(t) {
        ...
        for (var e = t.size.outerWidth % this.columnWidth, i = Math[e && e < 1 ? "round" : "ceil"](t.size.outerWidth / this.columnWidth), i = Math.min(i, this.cols), o = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](i, t), e = {
            ...
            y: o.y
        }, n = o.y + t.size.outerHeight, s = i + o.col, r = o.col; r < s; r++)
            this.colYs[r] = n;
        return e
    }
    ,
    ...
    t._manageStamp = function(t) {
        ...
        for (var s = (this._getOption("originTop") ? i.top : i.bottom) + e.outerHeight, r = o; r <= n; r++)
...
function(t, e) {
    ...
    "use strict";
    var i, t = t.create("masonry"), o = t.prototype, n = {
        _getElementOffset: !0,
        layout: !0,
        _getMeasurement: !0
    };
    for (i in e.prototype)
        n[i] || (o[i] = e.prototype[i]);
...
function(r, a) {
    ...
    n._filter = function(t) {
        for (var e = (e = this.options.filter) || "*", i = [], o = [], n = [], s = this._getFilterTest(e), r = 0; r < t.length; r++) {
            ...
            a && l.isHidden ? o.push(l) : a || l.isHidden || n.push(l))
        }
        return {
            matches: i,
            needReveal: o,
    ...
    var u = function(t) {
        if ("string" != typeof t)
            return t;
        var e, i, o = l(t).split(" "), n = o[0], t = (t = n.match(/^\[(.+)\]$/)) && t[1], s = (i = n,
        (e = t) ? function(t) {
...
function(d) {
    ...
    d.extend(d.fn, {
        accrue: function(n) {
            ...
            this.each(function() {
                ...
                f(e, n, "rate"),
                f(e, n, "term");
                switch ("compare" == n.mode && f(e, n, "rate_compare"),
                i = ".results" === n.response_output_div ? (0 === e.find(".results").length && e.append('<div class="results"></div>'),
                e.find(".results")) : d(n.response_output_div),
                n.mode) {
                case "basic":
                    o = t;
                    break;
                ...
                o(e, n, i),
                "button" == n.operation ? (0 === e.find("button").length && 0 === e.find("input[type=submit]").length && 0 === e.find("input[type=image]").length && e.find(".form").append('<button class="accrue-calculate">' + n.button_label + "</button>"),
                e.find("button, input[type=submit], input[type=image]").each(function() {
                    d(this).click(function(t) {
                        t.preventDefault(),
                        o(e, n, i)
                    })
    ...
    var f = function(t, e, i) {
        var o;
        return t.find(".accrue-" + i).length ? o = t.find(".accrue-" + i) : t.find("." + i).length ? o = t.find("." + i) : t.find("input[name~=" + i + "]").length ? t.find("input[name~=" + i + "]") : o = "",
        "string" != typeof o ? o.val() : "term_compare" != i && (t.find(".form").append('<div class="accrue-field-' + i + '"><p><label>' + e.field_titles[i] + ':</label><input type="text" class="' + i + '" value="' + e.default_values[i] + '" />' + (0 < e.field_comments[i].length ? "<small>" + e.field_comments[i] + "</small>" : "") + "</p></div>"),
        t.find("." + i).val())
    }
      , t = function(t, e, i) {
        var o, n = d.loanInfo({
        ...
        0 !== n ? (o = e.response_basic.replace("%payment_amount%", p(n.payment_amount_formatted, e)).replace("%num_payments%", n.num_payments).replace("%total_payments%", p(n.total_payments_formatted, e)).replace("%total_interest%", p(n.total_interest_formatted, e)),
        i.html(o)) : i.html(e.error_text),
        e.callback(t, n)
    }
      , s = function(t, e, i) {
        var o = f(t, e, "term_compare");
        "boolean" == typeof o && (o = f(t, e, "term"));
        var n = d.loanInfo({
            amount: f(t, e, "amount"),
            rate: f(t, e, "rate"),
            term: f(t, e, "term")
        ...
        0 !== n && 0 !== s ? (0 < n.total_interest - s.total_interest ? o.savings = n.total_interest - s.total_interest : o.savings = 0,
        n = e.response_compare.replace("%savings%", p(o.savings.toFixed(2), e)).replace("%loan_1_payment_amount%", p(s.payment_amount_formatted, e)).replace("%loan_1_num_payments%", s.num_payments).replace("%loan_1_total_payments%", s.total_payments_formatted).replace("%loan_1_total_interest%", p(s.total_interest_formatted, e)).replace("%loan_2_payment_amount%", p(n.payment_amount_formatted, e)).replace("%loan_2_num_payments%", n.num_payments).replace("%loan_2_total_payments%", n.total_payments_formatted).replace("%loan_2_total_interest%", p(n.total_interest_formatted, e)),
        i.html(n)) : i.html(e.error_text),
        e.callback(t, o)
    }
      , r = function(t, e, i) {
        var o = d.loanInfo({
        ...
        if (0 !== o) {
            for (var n = '<table class="accrue-amortization"><thead><tr><th class="accrue-payment-number">#</th><th class="accrue-payment-amount">Payment Amt.</th><th class="accrue-total-interest">Total Interest</th><th class="accrue-total-payments">Total Payments</th><th class="accrue-balance">Balance</th></tr></thead><tbody>', s = o.payment_amount - o.original_amount / o.num_payments, r = o.payment_amount - s, a = 0, l = 0, c = parseInt(o.original_amount, 10), u = 0; u < o.num_payments; u++) {
                a += s,
                l += o.payment_amount,
                c -= r;
                var h = "td";
                u == o.num_payments - 1 && (h = "th"),
                n = n + "<tr><" + h + ' class="accrue-payment-number">' + (u + 1) + "</" + h + "><" + h + ' class="accrue-payment-amount">' + p(o.payment_amount_formatted, e) + "</" + h + "><" + h + ' class="accrue-total-interest">' + p(a.toFixed(2), e) + "</" + h + "><" + h + ' class="accrue-total-payments">' + p(l.toFixed(2), e) + "</" + h + "><" + h + ' class="accrue-balance">' + p(c.toFixed(2), e) + "</" + h + "></tr>"
            }
            n += "</tbody></table>",
            i.html(n)
        } else
    ...
    d.loanInfo = function(t) {
        var e = (void 0 !== t.amount ? t.amount : 0).toString().replace(/[^\d.]/gi, "")
          , i = (void 0 !== t.rate ? t.rate : 0).toString().replace(/[^\d.]/gi, "")
          , o = (o = void 0 !== t.term ? t.term : 0).match("y") ? 12 * parseInt(o.replace(/[^\d.]/gi, ""), 10) : parseInt(o.replace(/[^\d.]/gi, ""), 10)
          , n = i / 100 / 12
          , t = Math.pow(1 + n, o)
          , t = e * t * n / (t - 1);
        return 0 < e * i * o ? {
            original_amount: e,
            payment_amount: t,
            payment_amount_formatted: t.toFixed(2),
            num_payments: o,
            total_payments: t * o,
            total_payments_formatted: (t * o).toFixed(2),
            total_interest: t * o - e,
            total_interest_formatted: (t * o - e).toFixed(2)
        } : 0
    }
    ,
    d.loanAmount = function(t) {
        var e = (void 0 !== t.payment ? t.payment : 0).toString().replace(/[^\d.]/gi, "")
          , i = (void 0 !== t.rate ? t.rate : 0).toString().replace(/[^\d.]/gi, "")
          , o = (o = void 0 !== t.term ? t.term : 0).match("y") ? 12 * parseInt(o.replace(/[^\d.]/gi, ""), 10) : parseInt(o.replace(/[^\d.]/gi, ""), 10)
          , t = i / 100 / 12
          , i = i / 100
          , i = e * (1 - Math.pow(1 + t, -1 * o)) * (12 / i);
        return 0 < i ? {
            principal_amount: i,
            principal_amount_formatted: i.toFixed(2),
            payment_amount: e,
            payment_amount_formatted: (+e).toFixed(2),
            num_payments: o,
            total_payments: e * o,
            total_payments_formatted: (e * o).toFixed(2),
            total_interest: e * o - i,
            total_interest_formatted: (e * o - i).toFixed(2)
        } : 0
    }
}(jQuery, (window,
document)),
function(t, e) {
    ...
    , function(t, e) {
        t.exports = function(t) {
            var e, i = "SELECT" === t.nodeName ? (t.focus(),
...
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {}
  , Prism = function(l) {
      ...
      , E = {
        ...
        languages: {
            ...
            DFS: function t(e, i, o, n) {
                ...
                for (s in e)
                    e.hasOwnProperty(s) && (i.call(e, s, e[s], o || s),
                    r = e[s],
                    "Object" !== (a = E.util.type(r)) || n[l(r)] ? "Array" !== a || n[l(r)] || (n[l(r)] = !0,
                    t(r, i, s, n)) : (n[l(r)] = !0,
                    t(r, i, null, n)))
            }
        },
        ...
        highlightAllUnder: function(t, e, i) {
            ...
            for (var n, s = o.elements || t.querySelectorAll(o.selector), r = 0; n = s[r++]; )
                E.highlightElement(n, !0 === e, o.callback)
        },
        highlightElement: function(t, e, i) {
            for (var o, n = "none", s = t; s && !c.test(s.className); )
                s = s.parentNode;
            s && (n = (s.className.match(c) || [, "none"])[1].toLowerCase(),
            o = E.languages[n]),
            t.className = t.className.replace(c, "").replace(/\s+/g, " ") + " language-" + n,
            t.parentNode && (s = t.parentNode,
            /pre/i.test(s.nodeName) && (s.className = s.className.replace(c, "").replace(/\s+/g, " ") + " language-" + n));
            function r(t) {
                a.highlightedCode = t,
            ...
            a.code ? (E.hooks.run("before-highlight", a),
            a.grammar ? e && l.Worker ? ((e = new Worker(E.filename)).onmessage = function(t) {
                r(t.data)
            }
            ,
        ...
        highlight: function(t, e, i) {
            ...
            return E.hooks.run("before-tokenize", i),
            ...
            for (var a in i)
                if (i.hasOwnProperty(a) && i[a]) {
                    ...
                    for (var l = i[a], l = "Array" === E.util.type(l) ? l : [l], c = 0; c < l.length; ++c) {
                        var u, h = l[c], d = h.inside, p = !!h.lookbehind, f = !!h.greedy, m = 0, g = h.alias;
                        f && !h.pattern.global && (u = h.pattern.toString().match(/[imuy]*$/)[0],
                        h.pattern = RegExp(h.pattern.source, u + "g")),
                        h = h.pattern || h;
                        for (var y = o, v = n; y < e.length; v += e[y].length,
                        ++y) {
                            var b = e[y];
                            ...
                            if (!(b instanceof I)) {
                                if (f && y != e.length - 1) {
                                    ...
                                    !(T = h.exec(t)))
                                        break;
                                    for (var w = T.index + (p ? T[1].length : 0), _ = T.index + T[0].length, x = y, C = v, $ = e.length; x < $ && (C < _ || !e[x].type && !e[x - 1].greedy); ++x)
                                        (C += e[x].length) <= w && (++y,
                                        v = C);
                                    if (e[y]instanceof I)
                                        continue;
                                ...
                                if (T) {
                                    ...
                                    _ = (w = T.index + m) + (T = T[0].slice(m)).length;
                                    var z = b.slice(0, w)
                                      , k = b.slice(_)
                                      , b = [y, S];
                                    z && (++y,
                                    v += z.length,
                                    b.push(z));
                                    z = new I(a,d ? E.tokenize(T, d) : T,g,T,f);
                                    if (b.push(z),
                                    k && b.push(k),
        ...
        tokenize: function(t, e) {
            ...
            return E.matchGrammar(t, i, e, 0, 0, !1),
            i
        },
        hooks: {
            all: {},
    ...
    I.stringify = function(t, e) {
        ...
        t.alias && (o = Array.isArray(t.alias) ? t.alias : [t.alias],
    ...
    ,
    !l.document)
        return l.addEventListener && (E.disableWorkerMessageHandler || l.addEventListener("message", function(t) {
    ...
    return t && (E.filename = t.src,
    E.manual || t.hasAttribute("data-manual") || ("loading" !== document.readyState ? window.requestAnimationFrame ? window.requestAnimationFrame(E.highlightAll) : window.setTimeout(E.highlightAll, 16) : document.addEventListener("DOMContentLoaded", E.highlightAll))),
    E
}(_self);
...
function(t) {
    ...
    (e = t.languages.markup) && (e.tag.addInlined("style", "css"),
