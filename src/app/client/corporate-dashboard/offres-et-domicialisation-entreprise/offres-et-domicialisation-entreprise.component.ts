...
@Component({
  selector: 'app-offres-et-domicialisation-entreprise',
  templateUrl: './offres-et-domicialisation-entreprise.component.html',
  styleUrls: ['./offres-et-domicialisation-entreprise.component.css']
})
export class OffresEtDomicialisationEntrepriseComponent implements OnInit{
  navData = navproData;
  offerForm: FormGroup;
